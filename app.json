{
      "name": "Scenario",
      "description": "An Anime Theme Telegram group management bot.",
      "keywords": [
         "telegram",
         "anime",
         "Scenario",
   ...
   "logo":    "https://telegra.ph/file/b2f2121639a12d557103c.jpg",  
   "repository": "https://github.com/TeamScenario/Scenario",
   "addons": [
          {
         "options": {
            "version": "12"
   ...
   "env": {
      ...
      "UPSTREAM_REPO": {
        "description": "Upstream repo for /update command, don't change.",
        "required": true,
        "value": "https://github.com/TeamScenario/Scenario"
      },
      "UPSTREAM_BRANCH": {
      ...
      "UPDATES_CHANNEL": {
         "description": "Updates channel without @",
         "value": "TeamScenario"
      },
      "SUPPORT_CHAT": {
     ...
     "EVENT_LOGS": {
         "description": "Make a new group then add @ScenarioXbot then send /id you'll get chat it fill it here.",
         "required": true,
         "value": ""
      },
      "JOIN_LOGGER": {
         "description": "A channel where bot will print who added it to what group, useful during debugging or spam handling. add @ScenarioXbot then send /id you'll get chat it fill it here.",
         "required": true,
         "value": ""
      },
      "API_OPENWEATHER": {
      ...
      "STRING_SESSION": {
         "description": "Telethon string session use @StarkStringGenBot and Never share your session.",
         "required": true,
         "value": ""
      },
      "YOUTUBE_API_KEY": {
      ...
      "HELP_IMG": {
         "description": "Image on /help command set telegraph link...Dm: @ScenarioXbot on telegram send the image you want to set and reply to the image then send /tgm and set that link :)",
         "required": false,
         "value": ""
      },
      "GROUP_START_IMG": {
         "description": "Image to show when someone to /start in groups set telegraph link...Dm: @ScenarioXbot on telegram send the image you want to set and reply to the image then send /tgm and set that link :)",
         "required": false,
         "value": ""
      },
      "GENIUS_API_TOKEN": {
         "description": "For lyrics get one from http://genius.com/api-clients",
         "required": false,
         "value": ""
      },
      "WALL_API": {
